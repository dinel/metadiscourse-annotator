...
set :deploy_to,   "/home2/dinel/subdomains/meta-marisa.dinel.org.uk"
set :app_path,    "app"

set :php_bin, "/usr/bin/php5-cli -d memory_limit=-1 -d allow_url_fopen=On "

set :repository,  "https://github.com/dinel/metadiscourse-annotator.git"

# see more at http://stackoverflow.com/questions/1524204/using-capistrano-to-deploy-from-different-git-branches
